...
export type ConsultaWhereInput = {
  ...
  idConsulta?: Prisma.IntFilter<"Consulta"> | number
  data?: Prisma.DateTimeFilter<"Consulta"> | Date | string
  idPaciente?: Prisma.IntFilter<"Consulta"> | number
  idProfissional?: Prisma.IntFilter<"Consulta"> | number
...
export type ConsultaScalarWhereWithAggregatesInput = {
  ...
  idConsulta?: Prisma.IntWithAggregatesFilter<"Consulta"> | number
  data?: Prisma.DateTimeWithAggregatesFilter<"Consulta"> | Date | string
  idPaciente?: Prisma.IntWithAggregatesFilter<"Consulta"> | number
  idProfissional?: Prisma.IntWithAggregatesFilter<"Consulta"> | number
}
...
export type ConsultaUncheckedUpdateInput = {
  idConsulta?: Prisma.IntFieldUpdateOperationsInput | number
  data?: Prisma.DateTimeFieldUpdateOperationsInput | Date | string
...
export type ConsultaOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"idConsulta" | "data" | "idPaciente" | "idProfissional", ExtArgs["result"]["consulta"]>
...
export interface ConsultaDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `idConsulta`
   * const consultaWithIdConsultaOnly = await prisma.consulta.findMany({ select: { idConsulta: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Consultas and only return the `idConsulta`
   * const consultaWithIdConsultaOnly = await prisma.consulta.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Consultas and only return the `idConsulta`
   * const consultaWithIdConsultaOnly = await prisma.consulta.updateManyAndReturn({
   *   select: { idConsulta: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ConsultaFieldRefs {
  readonly idConsulta: Prisma.FieldRef<"Consulta", 'Int'>
  readonly data: Prisma.FieldRef<"Consulta", 'DateTime'>
  readonly idPaciente: Prisma.FieldRef<"Consulta", 'Int'>
  readonly idProfissional: Prisma.FieldRef<"Consulta", 'Int'>
}
